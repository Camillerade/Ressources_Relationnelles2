...
return $this->render('site/Affichagefavoris.html.twig', [
    ...
    public function formulaireRessource(?Ressource $ressource,ManagerRegistry $doctrine, Request $request,EntityManagerInterface $ClassManager): Response
    { 
        // Récupérer l'utilisateur connecté
        $user = $this->getUser();
        ...
        if($form->isSubmitted()){
            ...
            $ClassManager= $doctrine->getManager();
            ...
            $ClassManager->persist($ressource);
            $ClassManager->flush();
        }
