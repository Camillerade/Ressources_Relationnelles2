 ...
 */
class getCategorieResRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategorieResRepository' shared autowired service.
     *
     * @return \App\Repository\CategorieResRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategorieResRepository.php';

        return $container->privates['App\\Repository\\CategorieResRepository'] = new \App\Repository\CategorieResRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
